...
const Index = () => {
  return (
    <div className="h-screen">
      <Head>
        <title>
          Home - Noodles Translation - English and Native Dutch Translation
        </title>
        <link rel="shortcut icon" href="/icons/favicon.ico" />
        <meta charSet="utf-8"></meta>
        <meta
          name="description"
          content="Noodles Translation provides accurate English and Dutch translation, transcription, and proofreading."
        ></meta>
        <meta
          name="keywords"
        ...
        <meta
          property="og:url"
          content="https://translation.noodles.services/"
        />
        <meta property="og:type" content="website" />
        <meta
          property="og:description"
          content="Accurate English and Dutch translation, transcription, and proofreading."
        />
