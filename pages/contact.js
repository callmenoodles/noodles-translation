  ...
  return(
    <div className='flex flex-col items-center'>
      <Head>
        ...
        <meta property="og:url" content="https://translation.noodles.services/contact" />
      ...
      <div className='flex flex-col items-center justify-center mb-24' style={{'minHeight':'calc(100vh - 64px - 6rem)'}}>
        <div className='flex flex-col maxmd:w-4/5 md:w-144'>
          ...
          <h3 className='mb-8 mt-2'>Send me a message if you need English to Dutch or Dutch to English translation, transcription, or proofreading. Questions? Don't hesitate to ask!</h3>
